...
// Defining the variants for the animation, copied from SaleReport.jsx
...
const PurchaseReport = () => {
  ...
  return (
    // Apply the staggered animation to the outermost div.
    <motion.div
      className="p-6"
        ...
        <div>
          ...
          <div className="bg-white mb-4 sm:mb-6">
            <div className="px-4 sm:px-6 py-4 border-gray-200">
              <h1 className="text-lg sm:text-xl font-semibold text-gray-900 text-center">Purchase Report</h1>
            </div>
                  ...
                  {productData.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">
                        ${item.purchasedAmount?.toLocaleString() || '0'}
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-900">
                        {item.purchasedQty?.toLocaleString() || 0}
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-900">
